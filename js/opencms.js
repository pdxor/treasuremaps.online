...

	{
	  ...
	  var krpano = document.getElementById("krpanoSWFObject");
			...
			wh.innerHTML = '<iframe style="height: 999px; width: 100%;" name="myIframe" frameborder="0" src="https://www.treasuremaps.online/pub-id-a-node/?ath='+mouse_at_h.toFixed(2)+'&atv='+mouse_at_v.toFixed(2)+'&urltag='+urltag+'"></iframe>';
